...
export const mainNav: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Shipping Belongings", href: "/shipping", description: "Moving your stuff to Argentina" },
      { label: "Driver's License", href: "/drivers-license", description: "Getting an Argentine license" },
      { label: "Insurance", href: "/insurance", description: "Health, home, car, and travel coverage" },
      { label: "Family Life", href: "/family-life", description: "Childcare, schools, and raising kids" },
      { label: "Legal Rights", href: "/legal-rights", description: "Know your rights as a foreigner" },
      { label: "Mail & Packages", href: "/mail-packages", description: "Receiving deliveries and postal tips" },
...
export const footerNav = {
  ...
  resources: [
    ...
    { label: "Family Life", href: "/family-life" },
