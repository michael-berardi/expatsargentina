...
export const nationalitiesBase: Nationality[] = [
  // URUGUAY - Full Featured Entry (Template Quality)
  {
    ...
    demonym: "Uruguayan",
    flag: "🇺🇾",
    title: "Uruguayan in Argentina | Complete Guide",
  ...
  // BOLIVIA - Full Featured Entry
  {
    ...
    demonym: "Bolivian",
    flag: "🇧🇴",
    title: "Bolivian in Argentina | Complete Guide",
  ...
  // BRAZIL - Full Featured Entry (Mercosur Full Member)
  {
    ...
    demonym: "Brazilian",
    flag: "🇧🇷",
    title: "Brazilian in Argentina | Complete Guide",
    subtitle: "Full Mercosur member benefits, 2-year temporary residency (convertible to permanent), and established community",
    ...
    specialAgreements: {
      ...
      description: "As a founding Mercosur member (1991), Brazilians receive 2-year temporary residency in Argentina, which can be converted to permanent residency after the 2-year period, with the fastest processing and fewest requirements of any nationality.",
      benefits: [
        "2-year temporary residency (convertible to permanent after 2 years)",
    ...
    documents: {
      ...
      criminalRecord: {
        required: true,
        apostille: true,
        notes: "Required for all Mercosur residency applications"
      },
      birthCertificate: {
        required: true,
        apostille: true
    ...
    residencyPath: {
      ...
      steps: [
        ...
        "Gather documents (including apostilled criminal record)",
        "Apply for Mercosur temporary residency at migraciones",
      ...
      tips: [
        ...
        "Get your criminal record apostilled before leaving Brazil",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "As a full Mercosur member, Brazilians get 2-year temporary residency, which can be converted to permanent residency after the 2-year period. Criminal record check is required. This is the fastest path to citizenship."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes! Once you apply for Mercosur residency, you receive a 'precaria' document that authorizes you to work immediately while your temporary residency card is processed."
      }
    ],
    relatedResources: [
      {
        title: "Mercosur Residency (Temporary to Permanent)",
        url: "/visas/permanent",
        description: "Full member details and pathway"
      },
      {
        title: "Cost of Living Guide",
        url: "/blog/cost-living-buenos-aires-2025",
  ...
  // VENEZUELA - Full Featured Entry (Non-Mercosur, Large Diaspora)
  {
    ...
    demonym: "Venezuelan",
    flag: "🇻🇪",
    title: "Venezuelan in Argentina | Complete Guide",
  ...
  // UNITED STATES - Full Featured Entry (Non-Mercosur, Digital Nomad Focus)
  {
    ...
    demonym: "American",
    flag: "🇺🇸",
    title: "US Citizens in Argentina | Complete Guide",
  ...
  // MEXICO - Full Featured Entry (Growing Latin American Community)
  {
    ...
    demonym: "Mexican",
    flag: "🇲🇽",
    title: "Mexican in Argentina | Complete Guide",
  ...
  // CANADA - Full Featured Entry (English/French Speaking, Similar to US Profile)
  {
    ...
    demonym: "Canadian",
    flag: "🇨🇦",
    title: "Canadian in Argentina | Complete Guide",
  ...
  // UNITED KINGDOM - Full Featured Entry (Post-Brexit Interest, English-Speaking)
  {
    ...
    demonym: "British",
    flag: "🇬🇧",
    title: "UK in Argentina | Complete Guide",
  ...
  // GERMANY - Full Featured Entry (European, Growing Interest)
  {
    ...
    demonym: "German",
    flag: "🇩🇪",
    title: "German in Argentina | Complete Guide",
  ...
  // AUSTRALIA - Full Featured Entry (English-Speaking, Working Holiday)
  {
    ...
    demonym: "Australian",
    flag: "🇦🇺",
    title: "Australian in Argentina | Complete Guide",
  ...
  // NEW ZEALAND - Full Featured Entry (English-Speaking, Similar to Australia)
  {
    ...
    flag: "🇳🇿",
    title: "New Zealand in Argentina | Complete Guide",
  ...
  // CHINA - Full Featured Entry (Major Asian Community)
  {
    ...
    demonym: "Chinese",
    flag: "🇨🇳",
    title: "Chinese in Argentina | Complete Guide",
  ...
  // ECUADOR - Full Featured Entry (Mercosur Associate, Andean Community)
  {
    ...
    demonym: "Ecuadorian",
    flag: "🇪🇨",
    title: "Ecuadorian in Argentina | Complete Guide",
  ...
  // PORTUGAL - Full Featured Entry (European, Brazilian Connections)
  {
    ...
    demonym: "Portuguese",
    flag: "🇵🇹",
    title: "Portuguese in Argentina | Complete Guide",
  ...
  // SOUTH KOREA - Full Featured Entry (Growing Asian Community)
  {
    ...
    flag: "🇰🇷",
    title: "South Korean in Argentina | Complete Guide",
    subtitle: "Growing community, business opportunities, and cultural exchange",
  ...
  // NETHERLANDS - Full Featured Entry (European, Business Focus)
  {
    ...
    demonym: "Dutch",
    flag: "🇳🇱",
    title: "Dutch in Argentina | Complete Guide",
  ...
  },
  {
    ...
    demonym: "Irish",
    flag: "🇮🇪",
    title: "Irish in Argentina | Complete Guide",
  ...
  },
  {
    ...
    demonym: "Argentine",
    flag: "🇦🇷",
    title: "Argentines: Returning Home Guide",
  ...
  },
  {
    ...
    demonym: "Belgian",
    flag: "🇧🇪",
    title: "Belgian in Argentina | Complete Guide",
  ...
  },
  {
    ...
    demonym: "Norwegian",
    flag: "🇳🇴",
    title: "Norwegian in Argentina | Complete Guide",
  ...
  },
  {
    ...
    demonym: "Danish",
    flag: "🇩🇰",
    title: "Danish in Argentina | Complete Guide",
    ...
    specialAgreements: {
      hasAgreement: true,
      type: "Working Holiday Agreement",
      description: "Denmark and Argentina have a bilateral Working Holiday Visa agreement for citizens aged 18-35, allowing up to 12 months of work and travel.",
      benefits: [
    ...
    residencyPath: {
      ...
      steps: [
        "Enter as tourist (90 days visa-free)",
        "If 18-35: Apply for Working Holiday Visa",
        "Or apply for digital nomad visa if working remotely",
        "Submit documents with apostille",
        "Receive temporary residency",
        "After 2 years, apply for permanent"
      ],
      tips: [
        "Working Holiday Visa available for ages 18-35",
    ...
    faqs: [
      {
        ...
        answer: "No for tourism - 90 days visa-free. For longer stays, the Working Holiday Visa (ages 18-35) or Digital Nomad Visa are the best options."
      },
      {
  ...
  },
  {
    ...
    demonym: "Finnish",
    flag: "🇫🇮",
    title: "Finnish in Argentina | Complete Guide",
  ...
  },
  {
    ...
    demonym: "Polish",
    flag: "🇵🇱",
    title: "Polish in Argentina | Complete Guide",
  ...
  // CUBA
  {
    ...
    demonym: "Cuban",
    flag: "🇨🇺",
    title: "Cuban in Argentina | Complete Guide",
  ...
  // DOMINICAN REPUBLIC
  {
    ...
    demonym: "Dominican",
    flag: "🇩🇴",
    title: "Dominican in Argentina | Complete Guide",
  ...
  // GUATEMALA
  {
    ...
    demonym: "Guatemalan",
    flag: "🇬🇹",
    title: "Guatemalan in Argentina | Complete Guide",
  ...
  // HONDURAS
  {
    ...
    demonym: "Honduran",
    flag: "🇭🇳",
    title: "Honduran in Argentina | Complete Guide",
  ...
  // EL SALVADOR
  {
    ...
    demonym: "Salvadoran",
    flag: "🇸🇻",
    title: "Salvadoran in Argentina | Complete Guide",
  ...
  // NICARAGUA
  {
    ...
    demonym: "Nicaraguan",
    flag: "🇳🇮",
    title: "Nicaraguan in Argentina | Complete Guide",
  ...
  // HAITI
  {
    ...
    demonym: "Haitian",
    flag: "🇭🇹",
    title: "Haitian in Argentina | Complete Guide",
  ...
  // PUERTO RICO
  {
    ...
    flag: "🇵🇷",
    title: "Puerto Rican in Argentina | Complete Guide",
  ...
  // BULGARIA
  {
    ...
    demonym: "Bulgarian",
    flag: "🇧🇬",
    title: "Bulgarian in Argentina | Complete Guide",
  ...
  // CROATIA
  {
    ...
    demonym: "Croatian",
    flag: "🇭🇷",
    title: "Croatian in Argentina | Complete Guide",
  ...
  // SERBIA
  {
    ...
    demonym: "Serbian",
    flag: "🇷🇸",
    title: "Serbian in Argentina | Complete Guide",
  ...
  // SLOVAKIA
  {
    ...
    demonym: "Slovak",
    flag: "🇸🇰",
    title: "Slovak in Argentina | Complete Guide",
  ...
  // SLOVENIA
  {
    ...
    demonym: "Slovene",
    flag: "🇸🇮",
    title: "Slovene in Argentina | Complete Guide",
  ...
  // ESTONIA
  {
    ...
    demonym: "Estonian",
    flag: "🇪🇪",
    title: "Estonian in Argentina | Complete Guide",
  ...
  // LATVIA
  {
    ...
    demonym: "Latvian",
    flag: "🇱🇻",
    title: "Latvian in Argentina | Complete Guide",
  ...
  // LITHUANIA
  {
    ...
    demonym: "Lithuanian",
    flag: "🇱🇹",
    title: "Lithuanian in Argentina | Complete Guide",
  ...
  // ALBANIA
  {
    ...
    demonym: "Albanian",
    flag: "🇦🇱",
    title: "Albanian in Argentina | Complete Guide",
  ...
  // BOSNIA
  {
    ...
    demonym: "Bosnian",
    flag: "🇧🇦",
    title: "Bosnian in Argentina | Complete Guide",
  ...
  // NORTH MACEDONIA
  {
    ...
    demonym: "Macedonian",
    flag: "🇲🇰",
    title: "Macedonian in Argentina | Complete Guide",
  ...
  // MOLDOVA
  {
    ...
    demonym: "Moldovan",
    flag: "🇲🇩",
    title: "Moldovan in Argentina | Complete Guide",
  ...
  // ICELAND
  {
    ...
    demonym: "Icelandic",
    flag: "🇮🇸",
    title: "Icelandic in Argentina | Complete Guide",
  ...
  // PAKISTAN
  {
    ...
    demonym: "Pakistani",
    flag: "🇵🇰",
    title: "Pakistani in Argentina | Complete Guide",
  ...
  // BANGLADESH
  {
    ...
    demonym: "Bangladeshi",
    flag: "🇧🇩",
    title: "Bangladeshi in Argentina | Complete Guide",
  ...
  // NEPAL
  {
    ...
    demonym: "Nepali",
    flag: "🇳🇵",
    title: "Nepali in Argentina | Complete Guide",
  ...
  // SRI LANKA
  {
    ...
    demonym: "Sri Lankan",
    flag: "🇱🇰",
    title: "Sri Lankan in Argentina | Complete Guide",
  ...
  // IRAN
  {
    ...
    demonym: "Iranian",
    flag: "🇮🇷",
    title: "Iranian in Argentina | Complete Guide",
  ...
  // IRAQ
  {
    ...
    demonym: "Iraqi",
    flag: "🇮🇶",
    title: "Iraqi in Argentina | Complete Guide",
  ...
  // JORDAN
  {
    ...
    demonym: "Jordanian",
    flag: "🇯🇴",
    title: "Jordanian in Argentina | Complete Guide",
  ...
  // LEBANON
  {
    ...
    demonym: "Lebanese",
    flag: "🇱🇧",
    title: "Lebanese in Argentina | Complete Guide",
  ...
  // ARMENIA
  {
    ...
    demonym: "Armenian",
    flag: "🇦🇲",
    title: "Armenian in Argentina | Complete Guide",
  ...
  // GEORGIA
  {
    ...
    demonym: "Georgian",
    flag: "🇬🇪",
    title: "Georgian in Argentina | Complete Guide",
  ...
  // MYANMAR
  {
    ...
    demonym: "Burmese",
    flag: "🇲🇲",
    title: "Burmese in Argentina | Complete Guide",
  ...
  // CAMBODIA
  {
    ...
    demonym: "Cambodian",
    flag: "🇰🇭",
    title: "Cambodian in Argentina | Complete Guide",
  ...
  // KUWAIT
  {
    ...
    demonym: "Kuwaiti",
    flag: "🇰🇼",
    title: "Kuwaiti in Argentina | Complete Guide",
  ...
  // QATAR
  {
    ...
    demonym: "Qatari",
    flag: "🇶🇦",
    title: "Qatari in Argentina | Complete Guide",
  ...
  // KAZAKHSTAN
  {
    ...
    demonym: "Kazakh",
    flag: "🇰🇿",
    title: "Kazakh in Argentina | Complete Guide",
  ...
  // AZERBAIJAN
  {
    ...
    demonym: "Azerbaijani",
    flag: "🇦🇿",
    title: "Azerbaijani in Argentina | Complete Guide",
  ...
  // UZBEKISTAN
  {
    ...
    demonym: "Uzbek",
    flag: "🇺🇿",
    title: "Uzbek in Argentina | Complete Guide",
  ...
  // KYRGYZSTAN
  {
    ...
    demonym: "Kyrgyz",
    flag: "🇰🇬",
    title: "Kyrgyz in Argentina | Complete Guide",
  ...
  // MONGOLIA
  {
    ...
    demonym: "Mongolian",
    flag: "🇲🇳",
    title: "Mongolian in Argentina | Complete Guide",
  ...
  // BAHAMAS
  {
    ...
    demonym: "Bahamian",
    flag: "🇧🇸",
    title: "Bahamian in Argentina | Complete Guide",
  ...
  // JAMAICA
  {
    ...
    demonym: "Jamaican",
    flag: "🇯🇲",
    title: "Jamaican in Argentina | Complete Guide",
  ...
  // TRINIDAD AND TOBAGO
  {
    ...
    demonym: "Trinidadian",
    flag: "🇹🇹",
    title: "Trinidadian in Argentina | Complete Guide",
  ...
  // BARBADOS
  {
    ...
    demonym: "Barbadian",
    flag: "🇧🇧",
    title: "Barbadian in Argentina | Complete Guide",
  ...
  // FIJI
  {
    ...
    demonym: "Fijian",
    flag: "🇫🇯",
    title: "Fijian in Argentina | Complete Guide",
  ...
  // PAPUA NEW GUINEA
  {
    ...
    flag: "🇵🇬",
    title: "Papua New Guinea in Argentina | Guide",
...
,
  ...
  // MALTA
  {
    ...
    demonym: "Maltese",
    flag: "🇲🇹",
    title: "Maltese in Argentina | Complete Guide",
  ...
  // CYPRUS
  {
    ...
    demonym: "Cypriot",
    flag: "🇨🇾",
    title: "Cypriot in Argentina | Complete Guide",
  ...
  // LUXEMBOURG
  {
    ...
    flag: "🇱🇺",
    title: "Luxembourger in Argentina | Complete Guide",
  ...
  // MONTENEGRO
  {
    ...
    demonym: "Montenegrin",
    flag: "🇲🇪",
    title: "Montenegrin in Argentina | Complete Guide",
  ...
  // BELARUS
  {
    ...
    demonym: "Belarusian",
    flag: "🇧🇾",
    title: "Belarusian in Argentina | Complete Guide",
  ...
  // TAJIKISTAN
  {
    ...
    demonym: "Tajik",
    flag: "🇹🇯",
    title: "Tajik in Argentina | Complete Guide",
  ...
  // TURKMENISTAN
  {
    ...
    demonym: "Turkmen",
    flag: "🇹🇲",
    title: "Turkmen in Argentina | Complete Guide",
  ...
  // BRUNEI
  {
    ...
    demonym: "Bruneian",
    flag: "🇧🇳",
    title: "Bruneian in Argentina | Complete Guide",
  ...
  // LAOS
  {
    ...
    demonym: "Lao",
    flag: "🇱🇦",
    title: "Lao in Argentina | Complete Guide",
  ...
  // SAMOA
  {
    ...
    demonym: "Samoan",
    flag: "🇼🇸",
    title: "Samoan in Argentina | Complete Guide",
  ...
  // MALDIVES
  {
    ...
    demonym: "Maldivian",
    flag: "🇲🇻",
    title: "Maldivian in Argentina | Complete Guide",
...
,
  ...
  // ANDORRA
  {
    ...
    demonym: "Andorran",
    flag: "🇦🇩",
    title: "Andorran in Argentina | Complete Guide",
