...
export const provincesBase: Province[] = [
  ...
  },
  {
    ...
    majorCities: ["Salta", "Tartagal", "Cafayate", "San Antonio de los Cobres"],
    keyFacts: [
...
export const citiesBase: City[] = [
  ...
  },
  {
    ...
    longDescription: "El Calafate exists because of ice — specifically, the Perito Moreno glacier, one of the few advancing glaciers on Earth and the star attraction of Los Glaciares National Park. The town sits on the shore of Lago Argentino, a milky blue glacial lake, and works best as a base for people who want Patagonia's biggest landscapes at their doorstep. You can visit Perito Moreno on a day trip, take boat excursions to the Upsala and Spegazzini glaciers, and use El Calafate as the jumping-off point for El Chaltén and the rest of southern Patagonia. The trade-off is that daily life is shaped by tourism: rents and groceries can spike in high season, winters feel quiet and windy, and the year-round job market is limited outside hospitality, guiding, transport, and support services. If you want a dramatic nature-first lifestyle and do not need a dense expat scene, El Calafate is memorable. If you need deep infrastructure or a diversified economy, it can feel isolated fast.",
    ...
    neighborhoods: [
      { name: "Centro", vibe: "Main strip around Avenida del Libertador — restaurants, tour agencies, walkable services, and the most tourist energy" },
      { name: "Costanera", vibe: "Lakefront promenade — scenic walks, bird watching, and a calmer feel away from the busiest commercial blocks" },
      { name: "Barrio Aeropuerto / upper residential areas", vibe: "More local and residential — quieter streets, more wind exposure, and better for longer stays than quick tourist visits" },
    ],
    keyFacts: [
    ...
    gettingThere: "Direct flights from Buenos Aires (roughly 3 hours) plus seasonal domestic links. Buses run from El Chaltén and other Patagonian hubs, but once you are in town you still need to plan excursions and airport transfers in advance.",
    bestFor: ["Glacier enthusiasts", "Nature photographers", "Trekkers", "Seasonal tourism workers", "People building a Patagonia basecamp"],
  ...
  },
  {
    ...
    longDescription: "La Plata is Argentina's most fascinating urban experiment — a city designed from scratch in 1882 with a strict diagonal grid, broad plazas, and enough public buildings to remind you that this is still the capital of Buenos Aires Province. What keeps it from feeling bureaucratic is the National University of La Plata (UNLP), one of the country's best-known public universities. The student population keeps the city young, affordable, and culturally busy, with bars, bookstores, rehearsal spaces, and political debate baked into everyday life. The cathedral is a genuine landmark, the Museo de La Plata is one of the strongest natural-history museums in Argentina, and weekend access to Buenos Aires is simple when you want the scale of the capital without paying Buenos Aires rents full-time. For expats, La Plata works best if you value walkability, study, research, architecture, and lower living costs more than nightlife polish or elite expat infrastructure.",
    ...
    neighborhoods: [
      { name: "Centro", vibe: "Administrative core around Plaza Moreno — cathedral views, museums, government offices, and nonstop student foot traffic" },
      { name: "Casco Urbano", vibe: "The classic diagonal grid — leafy blocks, cafés, university buildings, and the easiest car-free day-to-day life" },
      { name: "City Bell", vibe: "Green suburban pocket with larger homes, train access, and a calmer family rhythm while staying connected to the city" },
      { name: "Gonnet", vibe: "Residential and practical — parks, sports clubs, and lower-key local living popular with families and long-term renters" },
    ],
    keyFacts: [
    ...
    gettingThere: "Frequent trains from Buenos Aires Constitución, regular long-distance buses, and the Autopista La Plata-Buenos Aires for drivers. It is close enough for day trips to the capital but far enough to feel like its own city.",
    bestFor: ["Students", "Academics", "Architecture lovers", "Budget expats near BA", "Researchers and young professionals"],
