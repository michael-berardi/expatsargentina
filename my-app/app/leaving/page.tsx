...
export default function LeavingGuidePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-muted to-white">
      ...
      />
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-foreground via-foreground/90 to-foreground text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-muted-foreground/70 hover:text-white transition-colors mb-8"
          >
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">1. Why People Leave</h2>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-border">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-muted rounded-lg">
                    <reason.icon className="w-5 h-5 text-muted-foreground" />
                  </div>
                ...
                <blockquote className="border-l-4 border-blue-400 pl-4 italic text-muted-foreground text-sm">
                  {reason.quote}
                </blockquote>
              </div>
            ))}
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">2. Preparing to Leave</h2>
          </div>

          {/* Timing */}
          <div className="mb-12">
            <h3 className="text-2xl font-semibold text-foreground mb-6">Timing Your Departure</h3>
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div key={index} className="bg-white rounded-xl border border-border overflow-hidden">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-lg font-semibold text-foreground">{strategy.method}</h4>
          ...
          {/* Selling/Donating */}
          <div className="mb-12">
            <h3 className="text-2xl font-semibold text-foreground mb-6">Selling & Donating Your Stuff</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm border border-border">
                <h4 className="font-semibold text-foreground mb-3">What Sells Well</h4>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-border">
                <h4 className="font-semibold text-foreground mb-3">What to Donate</h4>
                <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-border">
                <h4 className="font-semibold text-foreground mb-3">What to Ship</h4>
                <ul className="space-y-2 text-sm text-muted-foreground">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">3. Administrative Tasks</h2>
          </div>
          ...
          <div className="mt-6 bg-white rounded-xl border border-border p-6">
            <h3 className="text-xl font-semibold text-foreground mb-4">Do You Need to Cancel Your DNI?</h3>
            <p className="text-muted-foreground mb-4">
              Short answer: Usually no, unless you're renouncing citizenship (which is rare and extreme).
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="font-medium text-foreground mb-2">Your DNI stays valid if:</p>
              ...
              <div>
                <p className="font-medium text-foreground mb-2">Consider formal renunciation if:</p>
                <ul className="space-y-1 text-sm text-muted-foreground">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">4. The Emotional Side</h2>
          </div>
          ...
          {/* Things You'll Miss */}
          <div className="mt-8 bg-gradient-to-br from-accent/5 to-yellow-50 rounded-xl p-8 border border-accent/10">
            <h3 className="text-2xl font-semibold text-foreground mb-6 flex items-center gap-2">
              <Sparkles className="w-6 h-6 text-white/850" />
          ...
          <div className="mt-8 bg-white rounded-xl border border-border p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="font-medium text-foreground mb-2">Temporary Returns</p>
                <ul className="space-y-1 text-sm text-muted-foreground">
              ...
              <div>
                <p className="font-medium text-foreground mb-2">Permanent Returns</p>
                <ul className="space-y-1 text-sm text-muted-foreground">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">5. Success Stories</h2>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-border">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{story.from} → {story.to}</p>
                  </div>
          ...
          <div className="mt-8 bg-muted rounded-xl p-6">
            <h3 className="text-lg font-semibold text-foreground mb-3">The Common Thread</h3>
            <p className="text-muted-foreground">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl font-bold text-foreground">6. If You're Just Visiting Home</h2>
          </div>
                    ...
                    {section.details.map((detail, i) => (
                      <div key={i} className="flex items-start gap-4 p-3 bg-muted rounded-lg">
                        ...
                        <div className="flex-1">
                          <p className="text-muted-foreground">{detail.limit}</p>
        ...
        {/* Final Thoughts */}
        <section className="mb-20">
          <div className="bg-gradient-to-br from-foreground via-foreground/90 to-foreground rounded-2xl p-8 text-white">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="mt-8 p-6 bg-white/10 backdrop-blur-sm rounded-xl">
                ...
                <p className="text-center text-muted-foreground/70 mt-2">
        ...
        {/* Quick Checklist */}
        <section className="mb-20">
          <h2 className="text-2xl font-bold text-foreground mb-6">Quick Departure Checklist</h2>
          <div className="bg-white rounded-xl border border-border p-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/guides/banking" className="group">
              <div className="bg-card rounded-xl p-6 border border-border hover:border-primary/30 hover:shadow-md transition-all">
                ...
                <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors">Banking & Money</h3>
                <p className="text-sm text-muted-foreground mt-1">Managing finances in Argentina</p>
              </div>
            </Link>
            <Link href="/guides/housing" className="group">
              <div className="bg-card rounded-xl p-6 border border-border hover:border-primary/30 hover:shadow-md transition-all">
                <Home className="w-8 h-8 text-primary mb-3" />
                <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors">Finding Housing</h3>
                <p className="text-sm text-muted-foreground mt-1">Renting apartments in Buenos Aires</p>
              </div>
            </Link>
            <Link href="/guides/visas" className="group">
              <div className="bg-card rounded-xl p-6 border border-border hover:border-primary/30 hover:shadow-md transition-all">
                <FileText className="w-8 h-8 text-primary mb-3" />
                <h3 className="font-semibold text-foreground group-hover:text-primary transition-colors">Visas & Residency</h3>
                <p className="text-sm text-muted-foreground mt-1">Staying legally in Argentina</p>
              </div>
            </Link>
          </div>
        </section>
        ...
        {/* FAQ Section */}
        <section className="py-16 md:py-24 bg-muted -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 mb-20">
