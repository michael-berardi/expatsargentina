...
const rosarioRestaurants: RosarioRestaurant[] = [
  ...
  // International
  {
    ...
    priceRange: "$$",
    description: "Rosario's craft beer scene is booming, and Berlina is at the forefront. A modern brewpub serving house-brewed beers alongside refined pub food including gourmet burgers and creative sharing plates.",
