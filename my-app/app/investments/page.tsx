          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Investments",
                "item": "https://expatsargentina.com/investments"
              }
            ]
          })
        }}
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                      <Button asChild variant="outline">
                        <Link href="https://lucerolegal.org?utm_source=expatsargentina&utm_medium=investments-cta" target="_blank" rel="noopener noreferrer">
        ...
        <div className="container mx-auto px-5">
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <p className="text-xs text-muted-foreground text-center">
              ...
              <Link href="https://lucerolegal.org?utm_source=expatsargentina&utm_medium=investments-disclaimer" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">
                Lucero Legal
              </Link>
